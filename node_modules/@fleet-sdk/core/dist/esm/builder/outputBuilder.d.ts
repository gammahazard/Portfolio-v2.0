import { Amount, Base58String, Box, BoxCandidate, ErgoTree, NewToken, NonMandatoryRegisters, OneOrMore, TokenAmount, UnsignedInput } from "@fleet-sdk/common";
import { ErgoAddress } from "../models";
import { TokenAddOptions, TokensCollection } from "../models/collections/tokensCollection";
export declare const SAFE_MIN_BOX_VALUE: bigint;
export declare class OutputBuilder {
    ...
    addTokens(tokens: OneOrMore<TokenAmount<Amount>> | TokensCollection, options?: TokenAddOptions): this;
